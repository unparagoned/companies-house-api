...
TOTAL_COMPANIES_DEFAULT = 100
SEARCH_DEFAULT = 'Statement of affairs'
DOCUMENTS_DEFAULT = 5
    ...
    try:
        ...
        while error_count < RETRIES:
            ...
            if response.status_code == 429:
                print str("Error waiting 5 min before retry")
                time.sleep(5 * 60 + 1)
                error_count += 1
        ...
        print str("--- API Call Error: " + sys.exc_info())
												...
												if 'resources' in document_metadata:
													...
													for content_type in document_metadata['resources']:
														try:
															...
															with codecs.open('cache/' + document_name, "wb") as f:
															#f = open('cache/' + document_name, "w")
															    f.write(document_content.content)
															    f.close()
														except:
															print ("Swallowed Exception 5")
										else:
											break
									except:
										print ("Swallowed Exception 4")
							except:
								print ("Swallowed Exception 3")
					except:
						print ("Swallowed Exception 2")
            except:
				print ("Swallowed Exception 1")
